...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__providers_event_api_event_api__ = __webpack_require__(224);
...
var HomePage = (function () {
    function HomePage(navCtrl, event) {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"/Users/yohannpro/Documents/Programmation/test-jobs/Events-Searcher/src/pages/home/home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Event\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-searchbar [(ngModel)]="terms"></ion-searchbar>\n  <ion-list>\n    <ion-item *ngFor="let e of events | search : terms | sort: {property: column, order: order}">\n      <ion-thumbnail item-start>\n        <img src="{{e.image}}">\n      </ion-thumbnail>\n      <h2>{{e.title}}</h2>\n      <p>Description: {{e.description}}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/yohannpro/Documents/Programmation/test-jobs/Events-Searcher/src/pages/home/home.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["d" /* NavController */], __WEBPACK_IMPORTED_MODULE_2__providers_event_api_event_api__["a" /* EventApiProvider */]])
    ], HomePage);
    return HomePage;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(221);
...
var EventApiProvider = (function () {
    function EventApiProvider(http) {
        this.http = http;
        this.apiUrl = 'https://tsh-app.firebaseio.com/events.json';
    }
    EventApiProvider.prototype.getEvents = function () {
    ...
    EventApiProvider.prototype.extractData = function (res) {
        var body = res;
        return body || {};
    };
    EventApiProvider.prototype.handleError = function (error) {
        var errMsg;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__providers_event_api_event_api__ = __webpack_require__(224);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pipes_search_search__ = __webpack_require__(399);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pipes_sort_sort__ = __webpack_require__(400);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["I" /* NgModule */])({
            ...
            providers: [
                ...
                __WEBPACK_IMPORTED_MODULE_8__providers_event_api_event_api__["a" /* EventApiProvider */]
            ]
        })
    ], AppModule);
    return AppModule;
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/yohannpro/Documents/Programmation/test-jobs/Events-Searcher/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/yohannpro/Documents/Programmation/test-jobs/Events-Searcher/src/app/app.html"*/
        }),
